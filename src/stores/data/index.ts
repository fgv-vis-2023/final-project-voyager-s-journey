...
export const loadData = async () => {
  const [
    ...
    d3.csv(
      `${basePath}/data/voyager1-daily-position.csv`
    ) as Promise<VoyagerDailyPosition>,
    d3.csv(
      `${basePath}/data/voyager2-daily-position.csv`
    ) as Promise<VoyagerDailyPosition>,
    d3.csv(`${basePath}/data/voyager1-images.csv`) as Promise<VoyagerImages>,
    d3.csv(`${basePath}/data/voyager2-images.csv`) as Promise<VoyagerImages>,
  ]);
